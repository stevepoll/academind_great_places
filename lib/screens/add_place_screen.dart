...
import 'package:academind_great_places/widgets/image_input.dart';
import 'package:academind_great_places/widgets/location_input.dart';
...
class _AddPlaceScreenState extends State<AddPlaceScreen> {
  ...
  void _savePlace() {
    if (_titleController.text.isEmpty ||
      ...
      // Add error handling here, maybe show dialog
      return;
    }
